...
const img = {
  ...
  dollychai: require("../../images/dollychai.jpg"),
  vadapavgirl: require("../../images/vadapavgirl.webp")
};
...
function App() {
  ...
  return (
    ...
    {/* <button className="btn-con" >back</button> */}
      {showModal ? (
        ...
        {filteredCards.map((card) => (
          ...
          >
            <div key={card._id} className="card1 bg-orange-400">
              <img src={getImageObject(card.image)} height={'200px'} width={'200px'} />
